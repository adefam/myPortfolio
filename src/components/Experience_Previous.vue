              ...
              <div>
                <div class="adefam-exp-holder md:flex-nowrap">
                  <div class="md:w-64 md:mb-0 adefam-exp-date" >
                    <span class="adefam-body-date">{{slide.date4}}</span>
                  </div>
                  <div class="md:flex-grow" >
                    <h2 class="adefam-exp-header">{{slide.title4}}</h2>
                    <p class="adefam-body" v-bind:style="classStyle">{{slide.content4}}</p>
                    <a class="adefam-exp-link" :href="slide.href4">{{slide.link4}}
