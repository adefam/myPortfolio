  ...
  <Popover>
    <div class="relative pt-6 px-4 sm:px-6 lg:px-8">
      <nav class="
          ...
          <div class="flex items-center justify-between w-full md:w-auto">
            ...
            <div class="-mr-2 flex items-center md:hidden">
              <PopoverButton class="
                  ...
                  hover:bg-gray-100
                  focus:outline-none
                  focus:ring-2 focus:ring-inset focus:#52A8F2
                ">
        ...
        <div class="hidden flex flex-grow flex-shrink-0 lg:flex-grow-0  md:block md:ml-10 md:pr-4 md:space-x-8">
          <a v-for="item in navigation" :key="item.name" :href="item.href"
            class="inline-flex font-medium adefam-number">{{ item.name }}</a>
        </div>
      ...
      <PopoverPanel focus class="
        ...
        <div class="
          ...
          <div class="px-5 pt-4 flex items-center justify-between">
            <div>
              <img v-for="image in navImage" :key="image.id" :src="image.src" :alt="image.alt" class="h-8 w-auto" loading="lazy" />
            </div>
            <div class="-mr-2">
              <PopoverButton class="
                  bg-white
          ...
          <div class="px-2 pt-2 pb-3 space-y-1">
            <a v-for="item in mobileNav" :key="item.name" :href="item.href" class="
                block
                px-3
                py-2
                rounded-md
...
<style>
.adefam-number{color:#52a8f2}.adefam-number:hover{color:orange}
</style> -->
      ...
      >
        ...
        <div class="hidden md:flex flex-grow flex-shrink-0 lg:flex-grow-0 md:ml-10 md:pr-4 items-center md:space-x-8">
          ...
          <a  :href="cvHref"
            ...
            class="inline-flex items-center gap-2 font-medium px-4 py-2 rounded-md border border-[#52A8F2] text-[#52A8F2] hover:bg-[#52A8F2] hover:text-white transition-colors"
          >
      ...
      <PopoverPanel focus class="absolute top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden">
        <div class="rounded-lg shadow-md bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">
          ...
          <div class="px-2 pt-2 pb-3 space-y-1">
            ...
            <a  v-for="item in mobileNav"
              :key="item.name"
              :href="item.href"
              class="block px-3 py-2 rounded-md text-base font-medium text-[#52A8F2] hover:text-orange-500 hover:bg-gray-50"
            >
           ...
           <a :href="cvHref"
            target="_blank"
            rel="noopener noreferrer"
            class="block w-full px-5 py-3 text-center font-medium text-[#52A8F2] bg-gray-50 hover:bg-gray-100"
          >
            Download CV
          </a>
        </div>
